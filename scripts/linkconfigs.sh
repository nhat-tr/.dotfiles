...
$DPATH/scripts/lnfilepath.sh $DPATH/home/.ripgreprc $HOME
...
# $DPATH/scripts/lnfilepath.sh $DPATH/home/config/nvim.eco/* $HOME/.config/nvim
# $DPATH/scripts/lnfilepath.sh $DPATH/home/config/nvim.lz/* $HOME/.config/nvim
